...
void 
trominoTile (int xBoard, int yBoard, int x_hole, int y_hole, int boardSize) 
{
...
if (board[xBoard][yBoard + 1] == 0 
	   &&board[xBoard + 1][yBoard] == 0 
...
if (board[xCenter][yCenter + 1] == 0 
	       &&board[xCenter + 1][yCenter] == 0 
